...
class NetHttpClientTest extends OauthTestCase {
	...
	public function setup() {
		...
		//$this->http = &new ClientHttp($this->requestUri->toString());
	...
	function testThatUsingGetParamsWorksWithPostRequestsThatHavePostBodies() {
...
//	function getTests() {return array('start', 'testThatPutBodiesNotSigned', 'end');}
